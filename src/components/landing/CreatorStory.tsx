        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="font-body text-base md:text-lg text-gray-600 mb-6">
              "Foi assim que nasceu o Rotina Mágica. Criei um sistema visual, lúdico e divertido, que transformou nossas vidas. A Sofia se tornou participativa, organizada e confiante. E eu... bom, eu voltei a ter paz. Criei isso para a minha filha, e agora compartilho com você."
            </p>
            <p className="font-subtitle font-bold text-brand-turquoise">- Carla Alves, mãe da Sofia e criadora do Rotina Mágica</p>
          </div>
        </div>
      </div>
    </section>
