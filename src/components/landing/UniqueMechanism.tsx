...
const mechanismCards = [
    { icon: <Eye className="w-8 h-8 md:w-10 md:h-10 text-white" />, title: "Comunicação Visual", description: "Crianças entendem imagens 60.000x mais rápido. É a língua nativa delas!" },
    { icon: <Gamepad2 className="w-8 h-8 md:w-10 md:h-10 text-white" />, title: "Recompensa e Dopamina", description: "O jogo ativa o centro de prazer do cérebro, associando tarefas a algo bom." },
    { icon: <BrainCircuit className="w-8 h-8 md:w-10 md:h-10 text-white" />, title: "Reduz Carga Mental", description: "O quadro se torna o 'chefe', não você. Adeus, repetições e estresse." },
    { icon: <Sparkles className="w-8 h-8 md:w-10 md:h-10 text-white" />, title: "Autonomia é Poder", description: "Assumir o controle das tarefas gera confiança e senso de capacidade." }
];
  ...
  return (
    <section className="py-20 lg:py-32 bg-brand-turquoise text-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mt-12 md:mt-16">
