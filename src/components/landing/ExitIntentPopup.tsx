    ...
    <div className="bg-white p-0 rounded-2xl shadow-2xl max-w-lg w-[95vw] sm:w-full mx-auto border-4 border-brand-orange grid grid-rows-[auto_1fr_auto] max-h-[90vh]">
        <div className="text-center p-4 sm:p-6 pb-2">
          <h1 className="font-headline text-xl sm:text-3xl md:text-4xl font-bold text-brand-dark-blue mb-1">
            Você está desistindo do futuro do seu filho.
          </h1>
          <p className="font-body text-sm sm:text-base md:text-lg text-brand-dark-blue/80 break-words overflow-hidden">
            A birra e o caos de hoje são sementes para um adulto perdido, sem foco e sem sucesso amanhã. Você realmente vai deixar isso acontecer por causa de R$27,90?
          </p>
        </div>
        ...
        <ScrollArea className="overflow-y-auto px-4 sm:px-6">
          <div className="my-4">
            ...
            <div className="bg-gray-50 rounded-2xl p-4 text-center border">
              <p className="font-headline font-bold text-brand-dark-blue text-base sm:text-lg uppercase">A Ferramenta para um Futuro Brilhante</p>
              ...
              <p className="font-body text-gray-500 text-xs sm:text-sm">Invista no comportamento, foco e responsabilidade dele. AGORA.</p>
            </div>
          </div>
        </ScrollArea>
            ...
            <a href="https://pay.kiwify.com.br/KbApxZm" className="w-full">
                <Button className="font-headline bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-4 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300 w-full h-auto animate-glow">
                    <div className="flex flex-col items-center leading-tight">
                        <span className="text-sm sm:text-base uppercase font-bold">SIM, EU QUERO UM FILHO VENCEDOR!</span>
                        <span className="text-xs sm:text-sm font-normal">Garantir o futuro por R$27,90</span>
                    </div>
                </Button>
            </a>
