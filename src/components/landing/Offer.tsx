      ...
      <div className="container mx-auto px-4 sm:px-6">
        <Card className="max-w-xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border-8 border-brand-gold">
          <div className="bg-brand-turquoise text-white text-center py-3">
            <p className="font-headline font-bold text-base sm:text-lg tracking-wide flex items-center justify-center gap-2">
          ...
          <CardContent className="p-6 sm:p-10 text-center">
            ...
            <div className="flex justify-center items-center gap-2 text-brand-orange mb-4">
              ...
              <p className="font-headline font-bold text-sm sm:text-base">ÚLTIMAS HORAS COM PREÇO PROMOCIONAL</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-4 sm:p-6 mb-8 border">
                <p className="font-body text-gray-500 text-xs sm:text-sm">Preço normal</p>
                <p className="font-headline text-xl sm:text-2xl font-bold text-gray-400 line-through decoration-2 mb-2">R$ 147,00</p>
                
                <p className="font-headline font-bold text-brand-turquoise text-base sm:text-lg uppercase">OFERTA ESPECIAL HOJE</p>
                
                <div className="flex justify-center items-baseline font-headline font-bold text-brand-turquoise !leading-none gap-2">
                    <span className="text-2xl sm:text-3xl">12x</span>
                ...
                <p className="font-body text-gray-500 text-xs sm:text-sm">ou R$37,00 à vista</p>
            </div>
            ...
            <BuyButton
              ...
              >
                <div className="flex flex-col items-center text-center leading-tight">
                  ...
                  <span className="text-xs sm:text-sm font-normal opacity-90 mt-1">Acesso vitalício e risco zero</span>
                </div>
            </BuyButton>
            ...
            <div className="flex items-center justify-center gap-3 mt-8 text-gray-600">
                ...
                <div className="text-left">
                    ...
                    <p className="text-xs font-body">Seu risco é zero. Se não amar, peça seu dinheiro de volta.</p>
                </div>
            </div>
          </CardContent>
        </Card>
