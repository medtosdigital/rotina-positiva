...
const faqItems = [
  {
    ...
    answer: "Você recebe acesso imediato e vitalício a uma plataforma com todos os arquivos dos Quadros de Rotina Positiva em PDF de alta resolução, prontos para imprimir. Isso inclui todos os quadros, cartões, moedas, estrelas e todos os bônus anunciados."
  },
  {
